/**
 * Manual tests for VectorSearch service
 * Run with: ts-node --esm src/services/vector-search/__tests__/VectorSearch.test.ts
 */

import { createVectorSearch } from '../index.js';
...
const embeddings1: StoredEmbedding[] = [
  {
    text: 'identical',
    vector: [1, 2, 3, 4, 5],
    source: 'test',
...
const vector2 = [1, 0, 0];
const embeddings2: StoredEmbedding[] = [
  {
    text: 'orthogonal',
    vector: [0, 1, 0],
    source: 'test',
...
const vector3 = [1, 2, 3];
const embeddings3: StoredEmbedding[] = [
  {
    text: 'opposite',
    vector: [-1, -2, -3],
    source: 'test',
...
const vector4 = [1, 0, 0];
const embeddings4: StoredEmbedding[] = [
...
console.log('\nTest 5: TopK limiting');
const vector5 = [1, 2, 3];
const embeddings5: StoredEmbedding[] = [
...
console.log('\nTest 8: TopK larger than embeddings array');
const embeddings8: StoredEmbedding[] = [
...
console.log('\nTest 10: Invalid query vector (null)');
assertThrows(
  () => vectorSearch.search(null as any, embeddings1, 1),
...
console.log('\nTest 11: Invalid embeddings (null)');
assertThrows(
  () => vectorSearch.search([1, 2, 3], null as any, 1),
...
console.log('\nTest 14: Mismatched vector dimensions');
const embeddingsMismatched: StoredEmbedding[] = [
...
console.log('\nTest 15: Empty vector in embeddings');
const embeddingsEmpty: StoredEmbedding[] = [
  { text: 'valid', vector: [1, 2, 3], source: 'test' },
...
console.log('\nTest 16: Zero vector handling');
const embeddingsZero: StoredEmbedding[] = [
...
const largeEmbeddings: StoredEmbedding[] = [
